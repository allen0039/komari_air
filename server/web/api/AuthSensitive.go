...
// 输入原始值:userUUID、2FA code。未启用 2FA 的用户放行;其余需要有效 code。
func VerifySensitive2FACore(userUUID, code string) error {
	if userUUID == "" {
...
func VerifySensitive2FA(c *gin.Context) error {
	...
	return VerifySensitive2FACore(uuid, get2FACode(c))
}
